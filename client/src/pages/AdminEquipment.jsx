          ...
          <div className="admin-form" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <input
                ...
                onChange={(e) => setForm({ ...form, penaltyPerDay: e.target.value })}
                placeholder="0"
              />
              ...
              <input
                ...
                placeholder="e.g. Construction, Event"
              />
              ...
              <textarea
                ...
                rows={2}
                placeholder="Damage details, maintenance notes..."
              />
            ...
            {equipment.length === 0 ? (
              ...
              equipment.map((item) => (
                <tr key={item._id}>
                  ...
                  <td><span className={`condition-badge ${(item.condition || 'Good').toLowerCase()}`}>{item.condition || 'Good'}</span></td>
                  <td>{item.isAvailable ? 'Yes' : 'No'}</td>
                  <td>
                    <button type="button" className="btn-edit" onClick={() => openEdit(item)}>
                      Edit
                    </button>
                    <button type="button" className="btn-delete" onClick={() => handleDelete(item._id, item.name)}>
                      Delete
                    </button>
                  </td>
                </tr>
